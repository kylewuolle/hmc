...
func (in *ClusterIPAM) DeepCopyInto(out *ClusterIPAM) {
	*out = *in
	...
	out.ClusterIPAMClaimRef = in.ClusterIPAMClaimRef
	if in.NodeIPClaims != nil {
		in, out := &in.NodeIPClaims, &out.NodeIPClaims
		*out = make([]corev1.TypedLocalObjectReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ClusterIPClaims != nil {
		in, out := &in.ClusterIPClaims, &out.ClusterIPClaims
		*out = make([]corev1.TypedLocalObjectReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ExternalIPClaims != nil {
		in, out := &in.ExternalIPClaims, &out.ExternalIPClaims
		*out = make([]corev1.TypedLocalObjectReference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *ClusterIPAMClaimSpec) DeepCopyInto(out *ClusterIPAMClaimSpec) {
	*out = *in
	in.NodeIPPool.DeepCopyInto(&out.NodeIPPool)
	in.ClusterIPPool.DeepCopyInto(&out.ClusterIPPool)
	in.ExternalIPPool.DeepCopyInto(&out.ExternalIPPool)
}
...
func (in *IpamSpec) DeepCopyInto(out *IpamSpec) {
	*out = *in
	if in.ClusterIpamRef != nil {
		in, out := &in.ClusterIpamRef, &out.ClusterIpamRef
		*out = new(corev1.ObjectReference)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeIPPoolSpec) DeepCopyInto(out *NodeIPPoolSpec) {
	*out = *in
	in.TypedLocalObjectReference.DeepCopyInto(&out.TypedLocalObjectReference)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeIPPoolSpec.
func (in *NodeIPPoolSpec) DeepCopy() *NodeIPPoolSpec {
	if in == nil {
		return nil
	}
	out := new(NodeIPPoolSpec)
	in.DeepCopyInto(out)
	return out
}
